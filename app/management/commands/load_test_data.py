...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        with transaction.atomic():
            ...
            FAQ.objects.create(question="Как устроены склады индивидуального хранения SelfStorage?", answer="Каждый склад сети SelfStorage – это отапливаемое и сухое помещение, оборудованное боксами различных размеров, которые вы можете арендовать для хранения вещей на любой срок от 1 месяца.", category="О складах и боксах")
            FAQ.objects.create(question="Какие условия хранения поддерживаются в складах SelfStorage?", answer="Во всех филиалах Кладовкин регулярно проводится уборка помещений, а также поддерживается постоянная температура и уровень влажности.", category="О складах и боксах")
            FAQ.objects.create(question="Какие меры безопасности соблюдаются в складах SelfStorage?", answer="Все складские помещения оборудованы электронной системой доступа по пин-коду, поэтому попасть на склад могут только арендаторы и доверенные лица. Более того, все склады находятся под видеонаблюдением, а служба круглосуточной заботы о клиентах Кладовкин осуществляет мониторинг и реагирование на нестандартные ситуации.", category="О складах и боксах")
            FAQ.objects.create(question="Чем, помимо местоположения, отличаются склады сети SelfStorage между собой?", answer="Наши склады бывают двух типов: автоматизированные и с администратором. Более того, каждый склад обладает некоторыми особенностями. Так, например, в некоторых складах есть возможность подъехать к боксу прямо на машине, в других прилегающая к складу территория обустроена под парковку. Чтобы найти подходящий под свои потребности склад, переходите на страницу Боксы и цены с возможностью настроить фильтрацию по ключевым характеристикам.", category="О складах и боксах")
